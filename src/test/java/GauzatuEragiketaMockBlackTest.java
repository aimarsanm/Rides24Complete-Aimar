...
public class GauzatuEragiketaMockBlackTest {
    ...
    @Test
    // BK-ak: 8
    // amount == null (aunque en Java `double` no puede ser `null`, simulamos un caso no válido)
    public void test3() {
        String username = "Julen";
    ...
    @Test
    // BK-ak: 9
    // deposit == null (aunque en Java `boolean` no puede ser `null`, simulamos un caso no válido)
    public void test4() {
        String username = "Julen";
        double amount = 3.0;
